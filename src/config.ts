...
export const FISH_CONFIG: Record<FishQuality, QualityConfig> = {
    [FishQuality.rotten]: {
        ...
        fishes: [
            ...
            { name: "废物螃蟹", prompt: "* 这条螃蟹说：我就是废物，你有意见？" },
            ...
            { name: "社死触手怪", prompt: "* 触手怪表示：这辈子最丢脸的时刻就在这一刻T_T" },
            { name: "躺平海参", prompt: "* 海参已躺平，拒绝社交！" },
            { name: "孙笑川258鱼", prompt: "* 258~这条鱼要坏掉了（但其实一直都是坏的）" },
            { name: "熬夜猝死鱼", prompt: "* 这条鱼告诉你要早睡，但它自己却熬夜到现在..." },
            { name: "过期老坛酸菜鱼", prompt: "* 这条鱼有点...但还是能吃...只是不建议吃" },
            ...
            { name: "当众社死鱼", prompt: "* 在所有人面前丢脸的经历改变了这条鱼..." },
    ...
    [FishQuality.moldy]: {
        ...
        fishes: [
            ...
            { name: "专科学历鱼", prompt: "* 一条学历不高的鱼，但工作经验老丰富了！" },
            ...
            { name: "UI还原度0%鱼", prompt: "* 这条鱼的设计图和实装差别太大了！！" },
            { name: "锦鲤转运鱼", prompt: "* 转运的说法听说就是心理安慰..." },
            { name: "日式鳗鱼饭", prompt: "* 这条鱼想过被煮成饭，瑟瑟发抖T_T" },
            { name: "挪威的森林鲭鱼", prompt: "* 一条有故事的鲭鱼..." },
            { name: "三文鱼刺身", prompt: "* 这条三文鱼已经做好被吃的准备了..." },
            { name: "内卷985鱼", prompt: "* 985大学毕业，还是卷不过这条鱼..." },
            { name: "ChatGPT替代鱼", prompt: "* 这条鱼担心被AI替代，但它忘了自己只是条鱼..." },
            { name: "第三方API寄了鱼", prompt: "* 第三方接口宕机，这条鱼也跟着崩了..." },
            { name: "debug到天亮鱼", prompt: "* 这条鱼陪程序员debug了一整夜，眼睛都红了..." },
            { name: "PTSD逃避鱼", prompt: "* 这条鱼有心理创伤，看到鱼线就瑟瑟发抖T_T" },
            { name: "独居老人鱼", prompt: "* 这条鱼已经很久没有和别的鱼交流了..." },
            { name: "考公上岸失败鱼", prompt: "* 考了N次公务员还是没上岸的鱼..." },
            { name: "跳票延期鱼", prompt: "* 这条鱼的发布日期永远在下个版本..." },
    ...
    [FishQuality.common]: {
        ...
        lengthRange: [1, 30],
        fishes: [
            { name: "尚方宝剑", prompt: "* 这条鱼自带尚方宝剑光环，但没人知道是什么意思..." },
            ...
            { name: "转运锦鲤", prompt: "* 民间传说中的转运神鱼，但能否转运全看运气..." },
            { name: "海底捞水母", prompt: "* 这条水母很贵，但服务态度最好！" },
            { name: "天使虾", prompt: "* 这只虾通体洁白，有种神圣的感觉..." },
            { name: "深海鲭鱼", prompt: "* 从深海压强极大的地方来到这里，已经适应了..." },
            { name: "澳洲龙虾", prompt: "* 远道而来的澳洲龙虾，价格不菲啊..." },
            { name: "挪威三文鱼", prompt: "* 原汁原味的挪威三文鱼，就是有点贵..." },
            ...
            { name: "老干妈海参", prompt: "* 用老干妈腌制的海参，有灵魂的味道..." },
            { name: "红烧鲷鱼", prompt: "* 这条鲷鱼已经预感到了自己的命运..." },
            { name: "白鲢鱼", prompt: "* 白鲢鱼：我很低调，就是个打酱油的..." },
            { name: "大马哈鱼", prompt: '* 大马哈鱼在俄语里叫"哈鱼"，哈哈哈...' },
            { name: "龙利鱼柳", prompt: "* 龙利鱼：我是龙，但现在被你吃掉一部分..." },
            { name: "小黄花鱼", prompt: "* 小黄花鱼虽然小，但是金贵着呢..." },
            { name: "中华田园鱼", prompt: "* 这是本土鱼种，就是有点普通..." },
            { name: "康师傅红烧牛肉面鱼", prompt: "* 这条鱼吃过太多康师傅面，已经变味了..." },
            { name: "沙雕鱼", prompt: "* 这条鱼很沙雕，你钓到了一条网红鱼！" },
            { name: "无语子鱼", prompt: "* 这条鱼不知道说什么好，已成语无伦次..." },
            { name: "摸鱼的鱼", prompt: "* 钓鱼的时候钓到了摸鱼的鱼，这算哲学吗？" },
            { name: "海洋馆逃犯", prompt: "* 这条鱼从海洋馆逃出来，现在重获自由..." },
            { name: "暴躁小龙虾", prompt: "* 这只龙虾脾气暴躁，分分钟要夹人..." },
            { name: "咋就睡不着鱼", prompt: "* 这条鱼有失眠症，整夜都在游来游去..." },
            { name: "滴滴出行鱼", prompt: "* 这条鱼是滴滴平台认证的出租车鱼..." }
        ]
    },
    [FishQuality.golden]: {
        name: "golden",
        ...
        fishes: [
            ...
            { name: "深海鲭鱼", prompt: "* 这条鲭鱼来自深海，见过黑暗的深处！" },
            { name: "毒河豚料理", prompt: "* 这是日本最危险的美食，一条鱼能要命！" },
            ...
            { name: "空心粉鱼", prompt: "* 这条鱼填充物是空心粉，但价格不便宜..." },
            { name: "本格蓝鳍金枪鱼", prompt: "* 日本本格蓝鳍金枪鱼，寿司之王..." },
            ...
            { name: "理财产品鱼", prompt: "* 这条鱼的投资回报率高达500%...相信我..." },
            { name: "五一黄金周特产鱼", prompt: "* 这条鱼只在五一黄金周出现..." }
        ]
    },
    [FishQuality.void]: {
        name: "void",
        ...
        fishes: [
            ...
            { name: "深渊乌贼", prompt: "* 来自深渊的乌贼，散发着邪恶的气息..." },
            { name: "传说鳗鱼", prompt: "* 鳗鱼界的传说人物，只在传说中出现..." },
            { name: "激光炮鱼", prompt: "* piu piu piu！这条鱼发射激光了！" },
            { name: "三文鱼皇帝", prompt: "* 三文鱼的皇帝级品质，至高无上..." },
            { name: "深海夜明珠", prompt: "* 深海中闪闪发光的夜明珠，珍稀异常..." },
            ...
            { name: "社恐珍珠", prompt: "* 这颗珍珠内向到极致，躲在壳子里不出来..." },
    ...
    [FishQuality.hidden_fire]: {
        ...
        fishes: [
            ...
            { name: "MrlingXD", prompt: "* 真心没想好写什么的 ling 写了这段毫无意义的说明" },
            ...
            { name: "红莲业火鲑鱼", prompt: "* 红莲业火燃烧在这条鲑鱼的全身！" },
